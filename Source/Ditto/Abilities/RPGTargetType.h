...
class DITTO_API URPGTargetType : public UObject
{
	GENERATED_BODY()
...
class DITTO_API URPGTargetType_UseOwner : public URPGTargetType
{
	GENERATED_BODY()
...
UCLASS(NotBlueprintable)
class DITTO_API URPGTargetType_UseEventData : public URPGTargetType
{
	GENERATED_BODY()
