...
#include "Ditto/RPGCharacterBase.h"
...
void URPGAttributeSet::GetLifetimeReplicatedProps(TArray<FLifetimeProperty>& OutLifetimeProps) const
{
	...
	DOREPLIFETIME(URPGAttributeSet, Healthreply);
	DOREPLIFETIME(URPGAttributeSet, Mana);
	DOREPLIFETIME(URPGAttributeSet, MaxMana);
	DOREPLIFETIME(URPGAttributeSet, Manareply);
	DOREPLIFETIME(URPGAttributeSet, Constitution);
	DOREPLIFETIME(URPGAttributeSet, Intelligence);
	DOREPLIFETIME(URPGAttributeSet, Critical_Hit_rate);
	DOREPLIFETIME(URPGAttributeSet, Critical_Damage);
	DOREPLIFETIME(URPGAttributeSet, Attack_Speed);
...
void URPGAttributeSet::OnRep_Healthreply(const FGameplayAttributeData& OldValue)
{
	GAMEPLAYATTRIBUTE_REPNOTIFY(URPGAttributeSet, Healthreply, OldValue);
}
...
void URPGAttributeSet::OnRep_Manareply(const FGameplayAttributeData& OldValue)
{
	GAMEPLAYATTRIBUTE_REPNOTIFY(URPGAttributeSet, Manareply, OldValue);
}


void URPGAttributeSet::OnRep_Constitution(const FGameplayAttributeData& OldValue)
{
	GAMEPLAYATTRIBUTE_REPNOTIFY(URPGAttributeSet, Constitution, OldValue);
}

void URPGAttributeSet::OnRep_Intelligence(const FGameplayAttributeData& OldValue)
{
	GAMEPLAYATTRIBUTE_REPNOTIFY(URPGAttributeSet,Intelligence, OldValue);
}

void URPGAttributeSet::OnRep_Critical_Hit_rate(const FGameplayAttributeData& OldValue)
{
	GAMEPLAYATTRIBUTE_REPNOTIFY(URPGAttributeSet, Critical_Hit_rate, OldValue);
}

void URPGAttributeSet::OnRep_Critical_Damage(const FGameplayAttributeData& OldValue)
{
	GAMEPLAYATTRIBUTE_REPNOTIFY(URPGAttributeSet, Critical_Damage, OldValue);
}

void URPGAttributeSet::OnRep_Attack_Speed(const FGameplayAttributeData& OldValue)
{
	GAMEPLAYATTRIBUTE_REPNOTIFY(URPGAttributeSet, Attack_Speed, OldValue);
}
