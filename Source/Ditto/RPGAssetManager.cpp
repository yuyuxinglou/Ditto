...
const FPrimaryAssetType	URPGAssetManager::EquipItemType = TEXT("Equip");
...
URPGAssetManager& URPGAssetManager::Get()
{
	...
	{
		UE_LOG(LogDitto, Fatal, TEXT("Invalid AssetManager in DefaultEngine.ini, must be RPGAssetManager!"));
...
{	
	...
	{
		UE_LOG(LogDitto, Warning, TEXT("Failed to load item for identifier %s!"), *PrimaryAssetId.ToString());
	}
